...
export default function About() {
  return (
    <div className="pg">
      ...
      <p className="lead2">Je joue au handball depuis longtemps, et je suis étudiant en STAPS, mention entraînement sportif. 6M Lab est né d'un constat simple : la plupart des joueurs amateurs n'ont pas accès à une vraie préparation physique, adaptée à leur sport et à leur emploi du temps.</p>
      ...
      <ul className="avow">
        ...
        <li><strong>L'objectif</strong><span>Aider les joueurs amateurs à progresser et à moins se blesser.</span></li>
      </ul>
