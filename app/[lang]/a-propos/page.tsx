...
export const metadata: Metadata = {
  ...
  description: "6M Lab est né de l'expérience de Raphaël : 5 ans en structures de haut niveau, entraîneur et préparateur physique d'une équipe.",
...
export default function About() {
  return (
    <div className="pg">
      ...
      <p className="lead2">Moi, c'est Raphaël. J'ai passé 5 ans en structures de haut niveau en handball : 5 entraînements par semaine, aux côtés de joueurs de centres de formation, dont certains jouent aujourd'hui en pro.</p>
      ...
      <p>Aujourd'hui, j'entraîne une équipe et j'en ai assuré la préparation physique cet été. Je poursuis en parallèle une formation STAPS, mention entraînement sportif.</p>
