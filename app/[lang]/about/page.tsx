...
export const metadata: Metadata = {
  title: "About | 6M Lab",
  description: "6M Lab was built by Raphaël: 5 years in an elite handball academy, now coach and strength coach of a team.",
...
export default function About() {
  return (
    <div className="pg">
      <h1>About 6M Lab</h1>
      <p className="lead2">I'm Raphaël. I spent 5 years in an elite handball academy: 5 training sessions a week, alongside academy players, some of whom now play professionally.</p>
      ...
      <p>Today I coach a team and ran its physical preparation this summer. I'm also a sport science student, specializing in training and coaching.</p>
