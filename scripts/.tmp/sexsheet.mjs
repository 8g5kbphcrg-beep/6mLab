...
let html = `<style>body{margin:0;font:13px sans-serif;background:#fff}.r{display:flex;align-items:center;border-bottom:1px solid #ddd}.r b{width:110px;padding:4px}svg{width:240px;height:240px}</style>`;
