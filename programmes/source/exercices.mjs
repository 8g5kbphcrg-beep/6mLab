...
export const exercices = {
  ...
  "ouverture-hanche": { name: "Ouverture de hanche en marchant", how: "En marchant, lève le genou sur le côté comme pour enjamber une barrière, puis ramène-le devant toi en gardant la hauteur, et repose le pied un pas plus loin. Change de jambe.", cues: "Buste droit, grand cercle avec le genou." },
  ...
  "ytw": { name: "Y-T-W", how: "À plat ventre, front posé sur une serviette. Décolle les bras du sol pour dessiner trois lettres avec ton corps : Y (bras tendus en diagonale au-dessus de la tête), T (bras écartés sur les côtés), puis W (coudes pliés, ramenés près des côtes). Tiens 2 secondes à chaque lettre en serrant les omoplates.", cues: "Pouces vers le plafond, pas de cambrure." },
  ...
  "hanches-9090": { name: "Mobilité des hanches 90/90", how: "Assis au sol, jambe avant pliée à 90° devant toi, jambe arrière pliée à 90° sur le côté. Lève les genoux et fais-les basculer de l'autre côté pour inverser les jambes, comme des essuie-glaces.", cues: "Buste droit, mouvement lent." },
  ...
  "rotation-thoracique": { name: "Rotation du haut du dos", how: "À quatre pattes, mains sous les épaules. Tourne le haut du dos en tendant un bras vers le plafond, en suivant ta main des yeux, puis repose-le et fais de même avec l'autre bras.", cues: "Le bassin ne bouge pas." },
};
