...
export const buy = {
  fr: {
    ...
    reath: "Réathlétisation seule : reprise progressive après blessure, avec le feu vert de ton médecin",
  ...
  en: {
    ...
    reath: "Return-to-play only: gradual comeback after injury, with your doctor's clearance",
