...
export const programs = {
  fr: {
    "pre-saison": {
      ...
      includes: ["Un PDF avec le planning complet, semaine par semaine", "Des vidéos qui montrent chaque exercice", "2 objectifs au choix, parmi 5 familles : développement musculaire, puissance et explosivité, condition physique, prévention et santé, entretien et retour au sport", "Ou un programme de réathlétisation, pour reprendre progressivement après une blessure", "En option (+9 €) : un programme de course à pied, avec des séances de 30 à 45 min"],
      phases: [
  ...
  en: {
    "pre-saison": {
      ...
      includes: ["A PDF with the full week-by-week plan", "Videos showing every exercise", "2 goals of your choice, from 5 families: muscle development, power and explosiveness, fitness, prevention and health, maintenance and return to sport", "Or a return-to-play program, for a gradual comeback after injury", "Optional (+€9): a running program, with 30 to 45 min sessions"],
      phases: [
