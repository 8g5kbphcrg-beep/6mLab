...
export const dict = {
  fr: {
    ...
    cmp: {
      ...
      goalsLb: "Objectifs (les deux formules) : 2 au choix, ou Réathlétisation", priceLb: "Prix", price: ["39,99 €", "29,99 €"],
  ...
  en: {
    ...
    cmp: {
      ...
      goalsLb: "Goals (both programs): pick 2, or return-to-play", priceLb: "Price", price: ["€39.99", "€29.99"],
